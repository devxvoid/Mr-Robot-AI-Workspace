...
enum class ApiProvider(
    ...
    OpenRouter(
        ...
        helpText = "Best for one key across many hosted models."
    ),
    OpenAI(
        displayName = "OpenAI",
        shortName = "OpenAI",
...
object AiModels {
    ...
    val supported = listOf(
        ...
        AiModel("meta-llama/llama-3.1-70b-instruct", "Llama 70B", "OpenRouter", "Open model through OpenRouter.", ApiProvider.OpenRouter),
        ...
        AiModel("gpt-4o", "GPT-4o", "OpenAI", "Flagship multimodal OpenAI model.", ApiProvider.OpenAI),
        ...
        AiModel("claude-3-5-haiku-latest", "Claude 3.5 Haiku", "Anthropic", "Fast Claude model for everyday use.", ApiProvider.Anthropic),

        AiModel("gemini-1.5-flash", "Gemini 1.5 Flash", "Google", "Fast Gemini model for chat and general tasks.", ApiProvider.Gemini),
        AiModel("gemini-1.5-pro", "Gemini 1.5 Pro", "Google", "Advanced Gemini model for deeper reasoning.", ApiProvider.Gemini),
        ...
        AiModel("mixtral-8x7b-32768", "Mixtral 8x7B", "Groq", "Fast mixture-of-experts model on Groq.", ApiProvider.Groq),

        AiModel("mistral-large-latest", "Mistral Large", "Mistral", "Advanced Mistral model.", ApiProvider.Mistral),
        AiModel("codestral-latest", "Codestral", "Mistral", "Mistral model optimized for coding.", ApiProvider.Mistral),
